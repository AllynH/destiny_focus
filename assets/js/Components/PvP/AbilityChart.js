      ...
      <div className='ability-chart-wrap flex-direction'>
        ...
        <p className='sub-heading'>Avg. kills per game.</p>
          <ul className='ability-list'>
            ...
            <li className='ability-list-li'><div className='icon weapon_icon'><Melee width={32} viewBox={'0 0 32 32'} /></div><div className='ability-detail-title'>WEAPONS: </div><div className='ability-detail-value'>{chartData.melee}</div></li>
