...
module.exports = {
  ...
  entry: {
    ...
    main_css: [
      ...
      path.join(__dirname, 'assets', 'js', 'Components', 'cards.css'),
  ...
  module: {
    rules: [
      ...
      { test: /\.js$/, exclude: /node_modules/, loader: 'babel-loader', query: { presets: ["@babel/preset-env", "@babel/preset-react"], cacheDirectory: true } },
    ],
  }
};
